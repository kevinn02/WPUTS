            ...
            <form  class="w-full" action="delete.php?id=<?= $data['nim']; ?>" method="POST">
                <table class="w-full">
                    <tr>
                        ...
                        <td class="py-2">:</td>
                        <td class="py-2"><input readonly type="number" id="nim" name="nim" value="<?= $data['nim'] ?>" class="bg-zinc-50 rounded-md shadow-sm w-full outline-none px-2 py-1 font-normal text-base font-poppins tracking-wide text-zinc-700"></td>
                    </tr>
                    <tr>
                        <td class="w-[140px] py-2"><label class="font-normal text-base font-poppins tracking-wider text-zinc-900" for="nama">Nama</label></td>
                        <td class="py-2">:</td>
                        <td class="py-2"><input readonly type="text" id="nama" name="nama" value="<?= $data['nama'] ?>" class="bg-zinc-50 rounded-md shadow-sm w-full outline-none px-2 py-1 font-normal text-base font-poppins tracking-wide text-zinc-700"></td>
                    </tr>
                    <tr>
                        ...
                        <td class="py-2">:</td>
                        <td class="py-2">
                            <select disabled id="jurusan" name="jurusan" class="bg-zinc-50 rounded-md shadow-sm w-full outline-none px-2 py-1 font-normal text-base font-poppins tracking-wide text-zinc-700">
                    ...
                    <tr>
                        ...
                        <td class="py-2">:</td>
                        <td class="py-2">
                            <select disabled id="prodi" name="prodi" class="bg-zinc-50 rounded-md shadow-sm w-full outline-none px-2 py-1 font-normal text-base font-poppins tracking-wide text-zinc-700">
                                <option selected disabled hidden></option>
                    ...
                    <tr>
                        ...
                        <td class="py-2">:</td>
                        <td class="py-2">
                            <select disabled id="gender" name="gender" class="bg-zinc-50 rounded-md shadow-sm w-full outline-none px-2 py-1 font-normal text-base font-poppins tracking-wide text-zinc-700">
                                <option selected disabled hidden></option>
                    ...
                    <tr>
                        ...
                        <td class="py-2">:</td>
                        <td class="py-2"><input readonly type="date" id="tanggal_lahir" name="tanggal_lahir" value="<?= $data['tanggal_lahir']?>" class="bg-zinc-50 rounded-md shadow-sm w-full outline-none px-2 py-1 font-normal text-base font-poppins tracking-wide text-zinc-700"></td>
                    </tr>
                </table>
                <div class="w-full mt-4 flex gap-3 justify-center">
                    <button type="submit" class="py-2 px-5 bg-color3 rounded-md shadow-sm font-semibold text-sm font-poppins tracking-wider text-zinc-50 hover:bg-red-800 duration-150">Delete</button>
