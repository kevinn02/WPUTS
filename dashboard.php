<?php
    ...
    if(isset($_SESSION['alert']) && $_SESSION['alert'] == 'hapus') {
        echo "<div></div>";
        echo "<script src='https://cdn.jsdelivr.net/npm/sweetalert2@11.7.3/dist/sweetalert2.all.min.js'></script><link href='https://cdn.jsdelivr.net/npm/sweetalert2@11.7.3/dist/sweetalert2.min.css' rel='stylesheet'><script>Swal.fire('Delete!','Data Berhasil Di Delete!','success')</script>";    
    }
                        ...
                        <thead>
                            <tr>
                                ...
                                <th class="border-b-2 border-zinc-700 px-5">
                                    <div class="px-4 py-2 bg-color2 rounded-md flex justify-center cursor-pointer shadow-sm hover:bg-green-700 duration-150"><a href="tambah.php" class="font-semibold text-base font-poppins tracking-wider text-zinc-50">Tambah</a></div>
                                </th>
                            </tr>
                        </thead>
                        <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="px-5 py-2 w-full flex gap-2">
                                            <div class="px-4 py-2 bg-color4 rounded-md flex justify-center cursor-pointer hover:bg-orange-600 duration-150 shadow-sm"><a href="update.php?id=<?= $data_tabel[$i]['nim']; ?>" class="font-semibold text-sm font-poppins tracking-wider text-zinc-50">Update</a></div>
                                            <div class="px-4 py-2 bg-color3 rounded-md flex justify-center cursor-pointer hover:bg-red-800 duration-150 shadow-sm"><a href="delete.php?id=<?= $data_tabel[$i]['nim']; ?>" class="font-semibold text-sm font-poppins tracking-wider text-zinc-50">Delete</a></div>
                                        </div>
                                    </td>
                                </tr>
                            <?php
