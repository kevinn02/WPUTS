            ...
            <form action="tambah.php" method="POST" class="w-full">
                <table class="w-full">
                    <tr>
                        ...
                        <td class="py-2">:</td>
                        <td class="py-2"><input required placeholder="Masukan NIM ..." type="number" id="nim" name="nim" class="bg-zinc-50 rounded-md shadow-sm w-full outline-none px-2 py-1 font-normal text-base font-poppins tracking-wide text-zinc-700"></td>
                    </tr>
                    <tr>
                        <td class="w-[140px] py-2"><label class="font-normal text-base font-poppins tracking-wider text-zinc-900" for="nama">Nama</label></td>
                        <td class="py-2">:</td>
                        <td class="py-2"><input required placeholder="Masukan Nama ..." type="text" id="nama" name="nama" class="bg-zinc-50 rounded-md shadow-sm w-full outline-none px-2 py-1 font-normal text-base font-poppins tracking-wide text-zinc-700"></td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td class="py-2">:</td>
                        <td class="py-2"><input required type="date" id="tanggal_lahir" name="tanggal_lahir" class="bg-zinc-50 rounded-md shadow-sm w-full outline-none px-2 py-1 font-normal text-base font-poppins tracking-wide text-zinc-700"></td>
                    </tr>
                </table>
                <div class="w-full mt-4 flex gap-3 justify-center">
                    <button type="submit" class="py-2 px-5 bg-color2 rounded-md shadow-sm font-semibold text-sm font-poppins tracking-wider text-zinc-50 hover:bg-green-700 duration-150">Submit</button>
